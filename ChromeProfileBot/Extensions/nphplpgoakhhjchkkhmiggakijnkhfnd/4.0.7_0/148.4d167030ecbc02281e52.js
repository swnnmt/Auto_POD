"use strict";
(self["webpackChunkmytonwallet"] = self["webpackChunkmytonwallet"] || []).push([[148],{
...
__webpack_require__.d(__webpack_exports__, {
  BluetoothLeWeb: () => (/* binding */ BluetoothLeWeb)
});

// EXTERNAL MODULE: ./node_modules/@capacitor/core/dist/index.js
var dist = __webpack_require__(16546);
// EXTERNAL MODULE: ./node_modules/@capacitor-community/bluetooth-le/dist/esm/conversion.js
var conversion = __webpack_require__(61389);
...
class BluetoothLeWeb extends dist/* WebPlugin */.E_ {
    constructor() {
        super(...arguments);
    ...
    onAdvertisementReceived(event) {
        ...
        if (isNew || ((_a = this.requestBleDeviceOptions) === null || _a === void 0 ? void 0 : _a.allowDuplicates)) {
            ...
            const result = {
                ...
                manufacturerData: (0,conversion/* mapToObject */.Li)(event.manufacturerData),
                serviceData: (0,conversion/* mapToObject */.Li)(event.serviceData),
                uuids: (_b = event.uuids) === null || _b === void 0 ? void 0 : _b.map(conversion/* webUUIDToString */.AG),
            };
    ...
    async write(options) {
        ...
        if (typeof options.value === 'string') {
            dataView = (0,conversion/* hexStringToDataView */.BR)(options.value);
        }
        else {
...
//# sourceMappingURL=148.4d167030ecbc02281e52.js.map